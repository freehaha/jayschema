...
// ******************************************************************
SchemaRegistry.prototype._registerImpl = function(schema, id, _resolutionScope, overwrite)
{
  // sanity check
  ...
  if (id) {
    ...
    if (this.isRegistered(resolvedId) && !overwrite) { return; }
...
// ******************************************************************
SchemaRegistry.prototype.register = function(schema, id, overwrite) {
  id = id || schema.id;
  if(overwrite === undefined) {
    overwrite = false;
  }
  this._registerImpl(schema, id, id, overwrite);
